...
#define SILKIT_ENABLE_TRACING_INSTRUMENTATION_AsioAcceptor 1
#define SILKIT_ENABLE_TRACING_INSTRUMENTATION_AsioConnector 1
#define SILKIT_ENABLE_TRACING_INSTRUMENTATION_AsioIoContext 1
#define SILKIT_ENABLE_TRACING_INSTRUMENTATION_AsioGenericRawByteStream 1

#define SILKIT_ENABLE_TRACING_INSTRUMENTATION_ConnectPeer 1

#define SILKIT_ENABLE_TRACING_INSTRUMENTATION_VAsioConnection 1
#define SILKIT_ENABLE_TRACING_INSTRUMENTATION_VAsioPeer 1
